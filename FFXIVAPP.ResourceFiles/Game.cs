...
namespace FFXIVAPP.ResourceFiles {
    ...
    public static class Game {
        ...
        public static Bitmap Bluemage = new Bitmap(GetResource($"{Constants.IconsPack}.blu.png"));
        ...
        public static Bitmap Dancer = new Bitmap(GetResource($"{Constants.IconsPack}.dnc.png"));
        ...
        public static Bitmap Gunbreaker = new Bitmap(GetResource($"{Constants.IconsPack}.gnb.png"));
